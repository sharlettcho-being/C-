...
namespace Practice11_1_1 {
    internal class Program {
        ...
        static void Main(string[] args) {
            string wXMLFilePath = "C:\\Users\\sharlettcho\\Desktop\\Sample11-1.xml";
            ...
            AddSoccerInfoAndSaveToFile(wXDoc, @"C:\Users\sharlettcho\Desktop\NewSports.xml", "サッカー", 11, 1863);
        ...
        public static void DisplayGamenameAndTeammembreCount(IEnumerable<XElement> vElements) {
            foreach (var wElement in vElements) {
                ...
                Console.WriteLine("{0} : {1}", wName.Value, wTeamMember.Value);
            }
            Console.WriteLine();
        }
